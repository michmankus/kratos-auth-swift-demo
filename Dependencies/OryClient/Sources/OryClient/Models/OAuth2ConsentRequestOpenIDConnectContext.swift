...
public struct OAuth2ConsentRequestOpenIDConnectContext: Sendable, Codable, Hashable {
    ...
    public init(acrValues: [String]? = nil, display: String? = nil, idTokenHintClaims: [String: JSONValue]? = nil, loginHint: String? = nil, uiLocales: [String]? = nil) {
