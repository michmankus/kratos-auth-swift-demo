...
public struct SettingsFlow: Sendable, Codable, Hashable {
    ...
    public init(active: String? = nil, continueWith: [ContinueWith]? = nil, expiresAt: Date, id: String, identity: Identity, issuedAt: Date, requestUrl: String, returnTo: String? = nil, state: JSONValue?, transientPayload: JSONValue? = nil, type: String, ui: UiContainer) {
        self.active = active
