...
public struct TokenPaginationRequestParameters: Sendable, Codable, Hashable {

    public static let pageSizeRule = NumericRule<Int64>(minimum: 1, exclusiveMinimum: false, maximum: 500, exclusiveMaximum: false, multipleOf: nil)
