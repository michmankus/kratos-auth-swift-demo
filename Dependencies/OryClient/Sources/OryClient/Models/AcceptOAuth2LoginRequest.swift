...
public struct AcceptOAuth2LoginRequest: Sendable, Codable, Hashable {
    ...
    public var extendSessionLifespan: Bool?
    ...
    public var identityProviderSessionId: String?
    ...
    public init(acr: String? = nil, amr: [String]? = nil, context: JSONValue? = nil, extendSessionLifespan: Bool? = nil, forceSubjectIdentifier: String? = nil, identityProviderSessionId: String? = nil, remember: Bool? = nil, rememberFor: Int64? = nil, subject: String) {
        self.acr = acr
        self.amr = amr
        self.context = context
        self.extendSessionLifespan = extendSessionLifespan
        self.forceSubjectIdentifier = forceSubjectIdentifier
        self.identityProviderSessionId = identityProviderSessionId
    ...
    public enum CodingKeys: String, CodingKey, CaseIterable {
        ...
        case amr
        case context
        case extendSessionLifespan = "extend_session_lifespan"
        case forceSubjectIdentifier = "force_subject_identifier"
        case identityProviderSessionId = "identity_provider_session_id"
        case remember
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(extendSessionLifespan, forKey: .extendSessionLifespan)
        try container.encodeIfPresent(forceSubjectIdentifier, forKey: .forceSubjectIdentifier)
        try container.encodeIfPresent(identityProviderSessionId, forKey: .identityProviderSessionId)
