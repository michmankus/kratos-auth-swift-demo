...
public struct CreateIdentityBody: Sendable, Codable, Hashable {
    ...
    public init(credentials: IdentityWithCredentials? = nil, externalId: String? = nil, metadataAdmin: JSONValue? = nil, metadataPublic: JSONValue? = nil, organizationId: String? = nil, recoveryAddresses: [RecoveryIdentityAddress]? = nil, schemaId: String, state: State? = nil, traits: JSONValue, verifiableAddresses: [VerifiableIdentityAddress]? = nil) {
