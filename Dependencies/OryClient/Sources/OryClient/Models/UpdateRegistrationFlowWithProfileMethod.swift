...
public struct UpdateRegistrationFlowWithProfileMethod: Sendable, Codable, Hashable {

    public enum Screen: String, Sendable, Codable, CaseIterable {
    ...
    public init(csrfToken: String? = nil, method: String, screen: Screen? = nil, traits: JSONValue, transientPayload: JSONValue? = nil) {
