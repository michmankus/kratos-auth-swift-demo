...
public struct ProjectMetadata: Sendable, Codable, Hashable {
    ...
    public init(createdAt: Date, environment: Environment, homeRegion: HomeRegion, hosts: [String], id: String, name: String, slug: String, state: State, subscriptionId: String? = nil, subscriptionPlan: String? = nil, updatedAt: Date, workspace: Workspace? = nil, workspaceId: String? = nil) {
