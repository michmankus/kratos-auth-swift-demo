...
public struct UpdateVerificationFlowWithCodeMethod: Sendable, Codable, Hashable {
    ...
    public init(code: String? = nil, csrfToken: String? = nil, email: String? = nil, method: Method, transientPayload: JSONValue? = nil) {
        self.code = code
