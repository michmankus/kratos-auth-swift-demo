...
public struct OidcConfiguration: Sendable, Codable, Hashable {
    ...
    public var credentialsEndpointDraft00: String?
    ...
    public var credentialsSupportedDraft00: [CredentialSupportedDraft00]?
    ...
    public init(authorizationEndpoint: String, backchannelLogoutSessionSupported: Bool? = nil, backchannelLogoutSupported: Bool? = nil, claimsParameterSupported: Bool? = nil, claimsSupported: [String]? = nil, codeChallengeMethodsSupported: [String]? = nil, credentialsEndpointDraft00: String? = nil, credentialsSupportedDraft00: [CredentialSupportedDraft00]? = nil, deviceAuthorizationEndpoint: String, endSessionEndpoint: String? = nil, frontchannelLogoutSessionSupported: Bool? = nil, frontchannelLogoutSupported: Bool? = nil, grantTypesSupported: [String]? = nil, idTokenSignedResponseAlg: [String], idTokenSigningAlgValuesSupported: [String], issuer: String, jwksUri: String, registrationEndpoint: String? = nil, requestObjectSigningAlgValuesSupported: [String]? = nil, requestParameterSupported: Bool? = nil, requestUriParameterSupported: Bool? = nil, requireRequestUriRegistration: Bool? = nil, responseModesSupported: [String]? = nil, responseTypesSupported: [String], revocationEndpoint: String? = nil, scopesSupported: [String]? = nil, subjectTypesSupported: [String], tokenEndpoint: String, tokenEndpointAuthMethodsSupported: [String]? = nil, userinfoEndpoint: String? = nil, userinfoSignedResponseAlg: [String], userinfoSigningAlgValuesSupported: [String]? = nil) {
        ...
        self.credentialsEndpointDraft00 = credentialsEndpointDraft00
        self.credentialsSupportedDraft00 = credentialsSupportedDraft00
    ...
    public enum CodingKeys: String, CodingKey, CaseIterable {
        ...
        case credentialsEndpointDraft00 = "credentials_endpoint_draft_00"
        case credentialsSupportedDraft00 = "credentials_supported_draft_00"
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(credentialsEndpointDraft00, forKey: .credentialsEndpointDraft00)
        try container.encodeIfPresent(credentialsSupportedDraft00, forKey: .credentialsSupportedDraft00)
        try container.encode(deviceAuthorizationEndpoint, forKey: .deviceAuthorizationEndpoint)
