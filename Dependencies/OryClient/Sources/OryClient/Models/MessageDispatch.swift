...
public struct MessageDispatch: Sendable, Codable, Hashable {
    ...
    public init(createdAt: Date, error: JSONValue? = nil, id: String, messageId: String, status: Status, updatedAt: Date) {
