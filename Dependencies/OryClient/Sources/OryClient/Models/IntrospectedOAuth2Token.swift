...
public struct IntrospectedOAuth2Token: Sendable, Codable, Hashable {
    ...
    public init(active: Bool, aud: [String]? = nil, clientId: String? = nil, exp: Int64? = nil, ext: [String: JSONValue]? = nil, iat: Int64? = nil, iss: String? = nil, nbf: Int64? = nil, obfuscatedSubject: String? = nil, scope: String? = nil, sub: String? = nil, tokenType: String? = nil, tokenUse: String? = nil, username: String? = nil) {
        self.active = active
        self.aud = aud
