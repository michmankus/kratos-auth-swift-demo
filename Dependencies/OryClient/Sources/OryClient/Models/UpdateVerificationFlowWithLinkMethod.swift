...
public struct UpdateVerificationFlowWithLinkMethod: Sendable, Codable, Hashable {
    ...
    public init(csrfToken: String? = nil, email: String, method: Method, transientPayload: JSONValue? = nil) {
