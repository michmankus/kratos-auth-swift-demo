...
public struct Identity: Sendable, Codable, Hashable {
    ...
    public init(createdAt: Date? = nil, credentials: [String: IdentityCredentials]? = nil, externalId: String? = nil, id: String, metadataAdmin: JSONValue? = nil, metadataPublic: JSONValue? = nil, organizationId: String? = nil, recoveryAddresses: [RecoveryIdentityAddress]? = nil, schemaId: String, schemaUrl: String, state: State? = nil, stateChangedAt: Date? = nil, traits: JSONValue?, updatedAt: Date? = nil, verifiableAddresses: [VerifiableIdentityAddress]? = nil) {
