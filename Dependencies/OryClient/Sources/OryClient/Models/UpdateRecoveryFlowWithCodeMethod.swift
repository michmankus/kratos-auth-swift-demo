...
public struct UpdateRecoveryFlowWithCodeMethod: Sendable, Codable, Hashable {
    ...
    public init(code: String? = nil, csrfToken: String? = nil, email: String? = nil, method: Method, recoveryAddress: String? = nil, recoveryConfirmAddress: String? = nil, recoverySelectAddress: String? = nil, screen: String? = nil, transientPayload: JSONValue? = nil) {
        self.code = code
