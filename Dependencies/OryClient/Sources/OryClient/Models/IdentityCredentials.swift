...
public struct IdentityCredentials: Sendable, Codable, Hashable {
    ...
    public init(config: JSONValue? = nil, createdAt: Date? = nil, identifiers: [String]? = nil, type: ModelType? = nil, updatedAt: Date? = nil, version: Int64? = nil) {
        self.config = config
