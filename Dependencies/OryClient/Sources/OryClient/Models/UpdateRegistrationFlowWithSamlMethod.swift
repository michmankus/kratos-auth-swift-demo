//
// UpdateRegistrationFlowWithSamlMethod.swift
//
...
public struct UpdateRegistrationFlowWithSamlMethod: Sendable, Codable, Hashable {
    ...
    public init(csrfToken: String? = nil, method: String, provider: String, traits: JSONValue? = nil, transientPayload: JSONValue? = nil) {
