...
open class OryClientAPIConfiguration: @unchecked Sendable {
    ...
    public init(
        basePath: String = "https://playground.projects.oryapis.com",
    ...
    public static let shared = OryClientAPIConfiguration()
}
...
open class RequestBuilder<T: Sendable>: @unchecked Sendable, Identifiable {
    ...
    public let apiConfiguration: OryClientAPIConfiguration

    /// Optional block to obtain a reference to the request's progress instance when available.
    public var onProgressReady: ((Progress) -> Void)?

    required public init(method: String, URLString: String, parameters: [String: any Sendable]?, headers: [String: String] = [:], requiresAuthentication: Bool, apiConfiguration: OryClientAPIConfiguration = OryClientAPIConfiguration.shared) {
        self.method = method
