...
public struct OAuth2LoginRequest: Sendable, Codable, Hashable {
    ...
    public init(challenge: String, client: OAuth2Client, oidcContext: OAuth2ConsentRequestOpenIDConnectContext? = nil, requestUrl: String, requestedAccessTokenAudience: [String]? = nil, requestedScope: [String]? = nil, sessionId: String? = nil, skip: Bool, subject: String) {
