...
public struct LoginFlow: Sendable, Codable, Hashable {

    public enum Active: String, Sendable, Codable, CaseIterable {
...
extension LoginFlow: Identifiable {}
