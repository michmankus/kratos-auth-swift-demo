...
public struct NormalizedProjectRevisionIdentitySchema: Sendable, Codable, Hashable {
    ...
    public var selfserviceSelectable: Bool?
    /** Last Time Project's Revision was Updated */
    public var updatedAt: Date?

    public init(createdAt: Date? = nil, id: String? = nil, identitySchema: ManagedIdentitySchema? = nil, identitySchemaId: String? = nil, importId: String? = nil, importUrl: String? = nil, isDefault: Bool? = nil, preset: String? = nil, projectRevisionId: String? = nil, selfserviceSelectable: Bool? = nil, updatedAt: Date? = nil) {
        ...
        self.selfserviceSelectable = selfserviceSelectable
    ...
    public enum CodingKeys: String, CodingKey, CaseIterable {
        ...
        case selfserviceSelectable = "selfservice_selectable"
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(selfserviceSelectable, forKey: .selfserviceSelectable)
        try container.encodeIfPresent(updatedAt, forKey: .updatedAt)
    }
}


extension NormalizedProjectRevisionIdentitySchema: Identifiable {}
