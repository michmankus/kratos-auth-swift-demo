...
public struct UiNodeInputAttributes: Sendable, Codable, Hashable {

    public enum Autocomplete: String, Sendable, Codable, CaseIterable {
        case email = "email"
        case tel = "tel"
        case url = "url"
    ...
    public enum OnclickTrigger: String, Sendable, Codable, CaseIterable {
    ...
    public enum OnloadTrigger: String, Sendable, Codable, CaseIterable {
        case orywebauthnregistration = "oryWebAuthnRegistration"
        case orywebauthnlogin = "oryWebAuthnLogin"
        case orypasskeylogin = "oryPasskeyLogin"
        case orypasskeyloginautocompleteinit = "oryPasskeyLoginAutocompleteInit"
    ...
    public init(autocomplete: Autocomplete? = nil, disabled: Bool, label: UiText? = nil, maxlength: Int64? = nil, name: String, nodeType: NodeType, onclick: String? = nil, onclickTrigger: OnclickTrigger? = nil, onload: String? = nil, onloadTrigger: OnloadTrigger? = nil, pattern: String? = nil, _required: Bool? = nil, type: ModelType, value: JSONValue? = nil) {
